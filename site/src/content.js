...
export const LEVELS=[
 ...
 {id:'crossfire',name:'Parallax Junction',subtitle:'Be in two places at the same time.',codename:'OPERATION PARALLAX',description:'Twin resonance locks must remain charged together. Divide the work across timelines while Lancers turn every corridor into a crossfire.',duration:12,maxLoops:7,player:{x:800,y:760},palette:{floor:'#0a1022',accent:'#ff3bd4',hazard:'#ffb347'},
  ...
  switches:[{id:'west',x:275,y:450,radius:62,color:'#39f6ff'},{id:'east',x:1325,y:450,radius:62,color:'#ff3bd4'}],spawns:[spawn(.5,'shooter',260,220),spawn(.5,'shooter',1340,220),spawn(2.5,'chaser',800,190),spawn(4.8,'chaser',260,675),spawn(4.8,'chaser',1340,675),spawn(7.2,'shooter',800,450),spawn(9.4,'tank',800,180)],goal:{type:'switches',ids:['west','east'],hold:1.6,thenKills:1},parScore:7200},
