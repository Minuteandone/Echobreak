...
export function createUI(callbacks={}){
 const ui=new EchoUI({onStart:callbacks.start,onRestart:callbacks.retry,onQuit:callbacks.quit,onResume:callbacks.resume,onPause:callbacks.pause,onSettings:s=>callbacks.settings?.(s),onMute:callbacks.toggleMute});
